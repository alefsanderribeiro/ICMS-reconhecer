...
def runNFe(Arquivo):
    ...
    ########################################################################################################################################################################################################
    dict_ide = {"cUF": None, "cNF": None, "natOp": None, "mod": None, "serie": None, "nNF": None, "dhEmi": None,
                "tpNF": None, "idDest": None, "cMunFG": None, "tpImp": None, "tpEmis": None, "cDV": None, "tpAmb": None,
                "finNFe": None, "indFinal": None, "indPres": None, "procEmi": None, "verProc": None, "Arquivo": None
                }
    ...
    ########################################################################################################################################################################################################
    dict_emit = {"CNPJ": None, "xNome": None, "xFant": None, "xLgr": None, "nro": None, "xCpl": None, "xBairro": None,
                 "cMun": None, "xMun": None, "UF": None, "CEP": None, "cPais": None, "xPais": None, "fone": None,
                 "IE": None, "CRT": None, "Arquivo": None}
    ...
    for i in nota.infNFe.det:
        dict_det = {"cProd": None, "cEAN": None, "xProd": None, "NCM": None, "CEST": None, "EXTIPI": None, "CFOP": None,
                    "uCom": None, "qCom": None, "vUnCom": None, "vProd": None, "cEANTrib": None, "uTrib": None,
                    "qTrib": None, "vUnTrib": None, "indTot": None, "xPed": None, "nItemPed": None, "nFCI": None,
                    "nItem": None, "cEnq": None, "IPINT": None, "det_icms_orig": None, "det_icms_CST": None,
                    "det_icms_modBC": None, "det_icms_vBC": None, "det_icms_pICMS": None, "det_icms_vICMS": None,
                    "det_icms_modBCST": None, "det_icms_pMVAST": None, "det_icms_vBCST": None, "det_icms_pICMSST": None,
                    "det_icms_vICMSST": None, "det_icms_identity": None, "PISNT": None, "COFINSNT": None,
                    "PISAliq_CST": None, "PISAliq_vBC": None, "PISAliq_pPIS": None, "PISAliq_vPIS": None,
                    "COFINSAliq": None, "COFINSAliq_CST": None, "COFINSAliq_vBC": None, "COFINSAliq_pCOFINS": None,
                    "COFINSAliq_vCOFINS": None, "Arquivo": None
                    }
...
if __name__ == '__main__':
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith('.xml'):
            ...
            df.to_excel(file_path.replace("xml", "xlsx").replace("nfe", "convert"),float_format="%.1f",index=False)
